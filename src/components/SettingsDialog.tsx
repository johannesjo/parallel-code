            ...
            >
              ...
              >
                ...
                >
                  ...
                  <option value="minimax">MiniMax (M2.7 / M3 for images)</option>
                </select>
              </label>
              ...
              <span style={{ 'font-size': '11px', color: theme.fgSubtle }}>
                {store.askCodeProvider === 'minimax'
                  ? 'Uses MiniMax-M2.7 (205K context) for text and MiniMax-M3 (1M context) for attached images via the OpenAI-compatible API — no Claude Code CLI required.'
